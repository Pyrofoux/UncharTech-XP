...
def BertGlue(task, bert_model="bert-base-uncased", mode = 'eval', dataPrefix = "./data", outputPrefix = "./output"):

    parser = {}

    parser["data_dir"]= dataPrefix+'/'+task
    parser["bert_model"]=bert_model
    parser["task_name"]=task
    parser["output_dir"]=outputPrefix+'/'+task
